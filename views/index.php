...
<tr>
                                            ...
                                            <a href="index.php?cat=realty&view=preview&id={$realty_one['realty_id']}" class="btn btn-default btn"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> Просмотр</a>
                                            <a href="index.php?cat=realty&view=edit&id={$realty_one['realty_id']}" class="btn btn-default btn"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Редактирование</a>
                                            <a href="index.php?cat=realty&view=delete&id={$realty_one['realty_id']}" class="btn btn-default btn"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Удаление</a>
                                            </div>
                                            </td>
                                            </tr>
